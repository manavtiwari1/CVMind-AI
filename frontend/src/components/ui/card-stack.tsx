  ...
  return (
    ...
    >
      ...
      >
        ...
        <div className="cardstack-spotlight-top" aria-hidden="true" />
        <div className="cardstack-spotlight-bottom" aria-hidden="true" />

        {/* Side navigation arrows */}
        <button
          onClick={prev}
          className="cardstack-arrow cardstack-arrow-left"
          disabled={!canGoPrev}
        ...
        <button
          onClick={next}
          className="cardstack-arrow cardstack-arrow-right"
          disabled={!canGoNext}
          ...
          <AnimatePresence initial={false}>
            {items.map((item, i) => {
              ...
              return (
                ...
                >
                  <div
                    className="cardstack-card-inner"
                    style={{
...
function DefaultFanCard({ item }: { item: CardStackItem; active: boolean }) {
  return (
    <div className="cardstack-default-card">
      {/* image */}
      <img
        src={item.imageSrc || "https://images.unsplash.com/photo-1460925895917-afdab827c52f?auto=format&fit=crop&w=800&q=80"}
        alt={item.title}
      ...
      {/* content */}
      <div className="cardstack-content">
        <div className="cardstack-title">
          {item.title}
        </div>
        {item.description ? (
          <div className="cardstack-desc">
            {item.description}
          </div>
        ) : null}
      </div>
